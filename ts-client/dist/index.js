...
function getAndCapMaxActiveBinSlippage(slippagePercentage, binStep, maxActiveBinSlippage) {
  return slippagePercentage != null ? Math.ceil(slippagePercentage / (binStep / 100)) : maxActiveBinSlippage;
}
...
var DLMM = class {
  ...
  async initializePositionAndAddLiquidityByStrategy({
    ...
    const maxActiveBinSlippage = slippage != null ? Math.ceil(slippage / (this.lbPair.binStep / 100)) : MAX_ACTIVE_BIN_SLIPPAGE;
